...
export const rateLimitExamples = [
  {
    ...
    scenarios: [
      ...
      },
      {
        ...
        value: "*/auth/*",
        description: "Strict limits on login/auth endpoints",
      ...
      },
      {
        name: "Public API",
        value: "*/api/public/*",
        description: "Moderate limits for public API access",
  ...
  },
  {
    ...
    scenarios: [
      ...
      },
      {
        ...
        value: "*/register",
        description: "Limit new user registrations",
        requestsPerMinute: 3,
        requestsPerHour: 15,
      },
      {
    ...
    scenarios: [
      {
        name: "Admin Panel",
        value: "*/admin/*",
        description: "Protect admin area from brute force",
      ...
      },
      {
        ...
        value: "*/wp-admin/*",
        description: "WordPress admin protection",
        requestsPerMinute: 10,
        requestsPerHour: 60,
      },
      {
        name: "Database Admin",
        value: "*/phpmyadmin/*",
        description: "Database admin tool protection",
        requestsPerMinute: 5,
        requestsPerHour: 30,
      },
    ],
  },
  {
    ...
    scenarios: [
      ...
      },
      {
        name: "Download Files",
        value: "*/download/*",
        description: "Limit file download requests",
        requestsPerMinute: 10,
        requestsPerHour: 50,
      },
      {
        name: "Export Data",
        value: "*/export/*",
        description: "Prevent data export abuse",
        requestsPerMinute: 3,
        requestsPerHour: 20,
      },
    ],
