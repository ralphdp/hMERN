...
const TrafficTrendsChart = () => {
  ...
  const [timeRange, setTimeRange] = useState(() => {
    return FirewallLocalStorage.getPreference("trafficChartTimeRange") || "12h";
  });
  const [granularity, setGranularity] = useState(() => {
    const storedTimeRange =
      FirewallLocalStorage.getPreference("trafficChartTimeRange") || "12h";
    const storedGranularity =
      FirewallLocalStorage.getPreference("trafficChartGranularity") || "minute";
  ...
  useEffect(() => {
    FirewallLocalStorage.setPreference("trafficChartGranularity", granularity);
  }, [granularity]);
        ...
        action={
          <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
            ...
            >
              ...
              {timeRange === "1h" && <MenuItem value="minute">Minute</MenuItem>}
              {(timeRange === "12h" ||
                timeRange === "24h" ||
